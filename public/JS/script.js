import { createMoviesSection } from "./components";


/* async function getPersonajes() {
    try {
        let response = await fetch('https://magicloops.dev/api/loop/e6e7b1ec-cd51-4d50-9609-41514a7a60da/run?query=Get+movie+info');
